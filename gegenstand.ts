 ...
 */
   ...
   * a) Getter für die Property Wert: get wert: number (return this._wert;)
   * <-- Perfekt!
   ...
   * 3. Für weiter oder später notwendige Zugriffe auf die Property '_wert':
   ...
   *   Setter für '_wert':
   *      set wert(wert: number): void {this._wert = wert;}
